...
//        [[cancelBtn titleLabel] setFont:[[BHFont sharedObject] bhFont4]];
        ...
        UIView *paddingView = [[UIView alloc] initWithFrame:CGRectMake(0, cancelBtn.bottom, SCREEN_SIZE.width, JA_TabbarSafeBottomMargin)];
        ...
        [bottomView setFrame:CGRectMake(0, SCREEN_SIZE.height, SCREEN_SIZE.width, bottomH+JA_TabbarSafeBottomMargin)];
