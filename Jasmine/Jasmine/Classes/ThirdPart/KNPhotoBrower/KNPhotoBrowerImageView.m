...
//            _progressHUD = progressHUD;
            ...
            // SDWebImage 下载图片
            [_imageView sd_setImageWithURL:url placeholderImage:placeHolder options:SDWebImageQueryDiskSync progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
