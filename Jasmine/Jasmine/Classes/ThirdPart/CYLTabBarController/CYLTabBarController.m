...
- (id)rootViewController {
    ...
    // UI架构导致要重新获取Tabbar
    MMDrawerController *rootViewController = (MMDrawerController *)[window.rootViewController cyl_getViewControllerInsteadOfNavigationController];;
    JABaseNavigationController *nav = (JABaseNavigationController *)rootViewController.centerViewController;
    CYLTabBarController *tab = (CYLTabBarController *)nav.childViewControllers.firstObject;
    if ([tab isKindOfClass:[CYLTabBarController class]]) {
