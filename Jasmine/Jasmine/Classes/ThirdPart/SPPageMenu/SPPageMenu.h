...
typedef NS_ENUM(NSInteger, SPPageMenuPermutationWay) {
    ...
    SPPageMenuPermutationWayNotScrollCustom
};
...
/** 首页需要调整标题的偏移量 */
@property (nonatomic, assign) UIEdgeInsets titleContentInset;
...
/*
 展示数目
 */
- (void)setRedCountLabelValue:(nullable NSString *)value index:(NSInteger)index;
