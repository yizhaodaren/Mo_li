...
@interface JFImageCollectionViewController () <UICollectionViewDelegate, UICollectionViewDataSource, JDPhotoBrowserDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate>
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    id obj = [ASSETHELPER getAssetAtIndex:indexPath.row];;
...
- (void)imagePickerController:(UIImagePickerController*)picker didFinishPickingMediaWithInfo:(NSDictionary*)info
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"kJFTakePhotoImage" object:image];
...
- (void)showNormalPhotoBrowser:(NSNotification *)notifi{
    ...
    if (currentIndex == 0)
    {
        ...
        {
            [self.view ja_makeToast:@"相机不可使用，请在设置中开启本软件的相机使用功能"];
        }
    }
    else
    {
