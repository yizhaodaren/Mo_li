...
- (void)setPageControlDotSpacing:(NSInteger)pageControlDotSpacing {
...
- (void)layoutSubviews
{
    ...
    if ([self.pageControl isKindOfClass:[TAPageControl class]]) {
        ...
        if (!(self.pageDotImage && self.currentPageDotImage && CGSizeEqualToSize(kCycleScrollViewInitialPageControlDotSize, self.pageControlDotSize))) {
            ...
            pageControl.selectedDotSize = self.pageControlSelectedDotSize;
        }
    ...
    CGFloat y = self.mainView.sd_height - size.height; // pagecontrol底部对齐
