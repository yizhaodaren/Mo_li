...
NSInteger NIMButtonItemHeight = 82;
NSInteger NIMPageRowCount     = 2;
NSInteger NIMPageColumnCount  = 4;
NSInteger NIMButtonBegintLeftX = 15;

@interface JANIMButton : UIButton

@end

@implementation JANIMButton
...
-(void)layoutSubviews
{
    ...
    if (self.imageView) {
        ...
        self.imageView.backgroundColor = HEX_COLOR(JA_backGrayColor);
        self.imageView.layer.cornerRadius = 8;
        self.imageView.layer.masksToBounds = YES;
        
        [self.titleLabel sizeToFit];
        self.titleLabel.centerX = self.width * 0.5;
        self.titleLabel.y = self.imageView.bottom + 7;
    }
...
- (void)genMediaButtons
{
    ...
    [items enumerateObjectsUsingBlock:^(NIMMediaItem *item, NSUInteger idx, BOOL *stop) {
        ...
        JANIMButton *btn = [[JANIMButton alloc] init];
        btn.tag = idx;
        ...
        [btn.titleLabel setFont:JA_LIGHT_FONT(12)];
