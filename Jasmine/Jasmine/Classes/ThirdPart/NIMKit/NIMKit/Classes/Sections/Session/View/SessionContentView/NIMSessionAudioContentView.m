...
- (void)setVocieImageIsReceiver:(BOOL)isReceiver {
    if (isReceiver) {
        ...
        UIImage * image = [UIImage nim_imageInKit:@"icon_receiver_voice_playing_003"];
        ...
        _voiceImageView.animationImages = animationImages;
        UIImage * image = [UIImage nim_imageInKit:@"icon_sender_voice_playing_003"];
        _voiceImageView.image = image;
  }
}
