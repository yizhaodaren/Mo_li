...
{
    [JAYXMessageManager app_sendMessageWithYXuserId:self.session.sessionId chatRecord:[self.dataSource items] finish:^{
        __weak typeof(self) weakSelf = self;
...
- (void)mediaLocationPressed
{
    ...
    vc.delegate = self;
    JABaseNavigationController *nav = [[JABaseNavigationController alloc] initWithRootViewController:vc];
