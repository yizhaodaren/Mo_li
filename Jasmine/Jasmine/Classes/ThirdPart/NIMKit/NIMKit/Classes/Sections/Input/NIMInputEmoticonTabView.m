...
#define sepColor HEX_COLOR_ALPHA(0x000000, 0.1)
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0,0, self.nim_width,JA_SCREEN_ONE_PIEXL)];
...
- (void)loadCatalogs:(NSArray*)emoticonCatalogs
{
    ...
    for (NIMInputEmoticonCatalog * catelog in emoticonCatalogs) {
        ...
        UIView *sep = [[UIView alloc] initWithFrame:CGRectMake(0, 0, JA_SCREEN_ONE_PIEXL, NIMInputEmoticonTabViewHeight)];
