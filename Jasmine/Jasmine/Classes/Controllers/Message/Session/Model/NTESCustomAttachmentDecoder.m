        ...
        if ([dict isKindOfClass:[NSDictionary class]])
        {
            ...
            switch (type) {
                ...
                case CustomMessageTypeWhiteboard:
                {
                    ...
                    break;
                case CustomMessageTypeMoliText:
                {
                    attachment = [[NTESMoliTextAttachment alloc] init];
                    ((NTESMoliTextAttachment *)attachment).text = [data jsonString:CMText];
                }
                    break;
                default:
                    break;
...
- (BOOL)checkAttachment:(id<NIMCustomAttachment>)attachment{
    ...
    else if ([attachment isKindOfClass:[NTESMoliTextAttachment class]]) {
        check = YES;
    }
    return check;
}
