...
- (void)defaultConfig {
    ...
    _placeHolderFrame = CGRectMake(12, 10, JA_SCREEN_WIDTH, 18);
    _debugMode = NO;
}
...
- (void)textDidChange:(NSNotification*)notification {
    ...
    if ([obj isKindOfClass:[JAPlaceHolderTextView class]] && obj == self) {
...
- (void)resetPlaceHolderFrame {
    ...
    [self setPlaceHolderFrame:CGRectMake(insets.left + leftDelta, insets.top + topDelta, JA_SCREEN_WIDTH - insets.left - insets.right, self.font.lineHeight + 2)];
}
